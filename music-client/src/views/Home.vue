<template>
  ...
  <!--热门歌单-->
  <play-list class="play-list-container" title="歌單" path="song-sheet-detail" :playList="songList"></play-list>
  <!--热门歌手-->
...
import { swiperList } from "@/enums/swiper";
